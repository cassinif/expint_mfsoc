% This function performs the time integration of the backward equation when
% the selective function is equal to one by means of the exponential
% Euler--Magnus method. For more details, see [ACCC24].
%
...
function psi = backward_exp_sone(psi0,rho,u,opts)
  ...
  for i = 1:opts.ts
    ...
    AA = opts.sigma^2/2*opts.D2b+...
         spdiags(opts.Mp*rhon+un,0,opts.n,opts.n)*opts.D1b+...
         opts.Mq*spdiags(rhon,0,opts.n,opts.n)*opts.D1b;
